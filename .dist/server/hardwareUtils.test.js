...
describe('findTimeAfterDistance function', () => {
    it('returns the start time when distance is zero', () => {
        const startTime = 100;
        const distance = 0;
        const speedQueue = [{ time: startTime, speed: 10, ref: setTimeout(() => { }, 0) }];
        const result = (0, hardwareUtils_1.findTimeAfterDistance)(startTime, distance, speedQueue);
    ...
    it('calculates finish past the last speed change', () => {
        ...
        const speedQueue = [{ time: startTime - 1000, speed: 1, ref: setTimeout(() => { }, 0) }];
...
describe('findPositionAtTime function', () => {
    it('returns the start position when startTime is equal to endTime', () => {
        ...
        const startPos = 100;
        const speedQueue = [{ time: startTime, speed: 10, ref: setTimeout(() => { }, 0) }];
        const result = (0, hardwareUtils_1.findPositionAtTime)(startPos, startTime, endTime, speedQueue);
