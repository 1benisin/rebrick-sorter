...
export type EventPayloads = {
  ...
  [AllEvents.CLEAR_HARDWARE_ACTIONS]: void;
  [AllEvents.CONVEYOR_ON_OFF]: void;
  [AllEvents.MOVE_SORTER]: { sorter: number; bin: number };
  [AllEvents.FIRE_JET]: { sorter: number };
  [AllEvents.HOME_SORTER]: { sorter: number };
  [AllEvents.LOG_PART_QUEUE]: void;
  [AllEvents.LOG_SPEED_QUEUE]: void;
  [AllEvents.LIST_SERIAL_PORTS]: void;
  [AllEvents.ABC_TEST]: void;
